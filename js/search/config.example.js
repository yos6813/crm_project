...
exports.FB_URL   = 'https://crmapp-32675.firebaseio.com/';
...
exports.paths = [
  {
    ...
    index : "firebase",
    type  : "post",
    fields: ['companyType', 'postCusPhone', 'postCustomer', 'postDate', 'postState',
    	'postType', 'uid', 'uploadfile', 'userImg', 'title', 'tags', 'text', 'username'],
